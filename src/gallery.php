...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="myHeader">
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../index.html#punkt1">Journal</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../index.html#punkt2">GD Library</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../index.html#punkt3">Animated GIF</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../index.html#punkt4">Skalieren</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="gallery.php">Galerie</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../index.html#punkt6">Video</a>
            </li>
        </ul>
    </div>
</nav>
